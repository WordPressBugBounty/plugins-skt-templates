...
= 6.30.17 =
* Added SKT Marketer in Elementor Templates.
...
= 6.30.14 =
* Added SKT Laboratory in Elementor Templates.

= 6.30.13 =
* Fixed: Resolved a browser security warning caused by the admin menu icon.

= 6.30.12 =
* Added SKT Coworking in Elementor Templates.

= 6.30.11 =
* Added SKT Copywriter in Elementor Templates.

= 6.30.10 =
* Added SKT Plastic Surgery in Elementor Templates.
...
= 6.30.5 =
* Added SKT Eatsy in Elementor Templates.
* Fixed Elementor Optimize Markup issue in the following Elementor templates: Maintenance Services, SKT White, SKT Sushi, SKT Restara
