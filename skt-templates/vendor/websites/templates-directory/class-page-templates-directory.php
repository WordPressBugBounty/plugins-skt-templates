		...
		public function templates_list() {
			...
			$templates_list = array(
				'skt-marketer'	=> array(
					...
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-marketer/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-marketer/skt-marketer.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-marketer/skt-marketer.json'),
					'keywords'    => __( ' digital marketer, online marketing specialist, internet marketer, digital advertising expert, online marketing professional, web marketer, digital strategist, e-commerce marketer, SEO specialist, social media marketer, marketer' ),
				),			
				'skt-ortho'	=> array(
					'title'       => __( 'SKT Ortho', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-ortho/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-ortho/skt-ortho.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-ortho/skt-ortho.json'),
					'keywords'    => __( ' orthopaedic, orthopaedy, hydropathic, bones, chiropractor, physiotherapy, skeletal, musculoskeletal surgeon, physician, physicaltherapy, spine, surgical, orthop, bowlegs, ortopedicsurgeons, PainManagement, OrthopedicPT, ortho, Ortho' ),
				),			
				'skt-lace'	=> array(
				...
				'skt-copywriter'	=> array(
					...
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-copywriter/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-copywriter/skt-copywriter.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-copywriter/skt-copywriter.json'),
					'keywords'    => __( ' content writer, advertising writer, marketing writer, creative writer, copy editor, content creator, brand storyteller, ad copywriter, wordsmith, communications writer, copy writer, Copy Writer' ),
				),
				...
				'skt-logistics'              => array(
					...
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-logistics/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-logistics/skt-logistics.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-logistics/skt-logistics.json'),
					'keywords'    => __( ' logistics, logistic, Logistics, sales logistics, movers and packers, procurement, production, recovery, recycling , procuring raw materials, warehouse, material management, distribution in factories, product management, shipping, recycling products, packaging, recycling recyclable products, recovering products, freight companies, freight forwarders, import, export, carriers, outsourced logistics, transportation, storage services, logistics department, small package, parcel delivery, air cargo, international commerce, ocean transport, bulk carriers, container ships, tankers, refrigerated ships' ),
				),
